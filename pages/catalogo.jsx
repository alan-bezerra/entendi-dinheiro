              ...
              <ul className="catalogo__cursos-list">
                  ...
                  <Box className="curso-item">
                    <header className="flex curso-item__header align-items">
                      <div className="curso-item__logo">
                        <img src="../assets/cursos/primeiros-passos-logo.svg" />
                      </div>
                ...
                <li>
                  <Box className="curso-item">
                    <header className="flex curso-item__header align-items">
                      <div className="curso-item__logo">
                        <img src="../assets/cursos/como-controlar-gastos-logo.svg" />
                      </div>
                    </header>
                ...
                <li>
                  <Box className="curso-item">
                    <header className="flex curso-item__header align-items">
                      <div className="curso-item__logo">
                        <img src="../assets/cursos/comece-a-investir-logo.svg" />
                      </div>
                    </header>
              ...
              <ul className="catalogo__cursos-list">
                <li>
                  <Box className="curso-item">
                    <header className="flex curso-item__header align-items">
                      <div className="curso-item__logo">
                        <img src="../assets/cursos/entendendo-cartao-logo.svg" />
                      </div>
                    </header>
                ...
                <li>
                  <Box className="curso-item">
                    <header className="flex curso-item__header align-items">
                      <div className="curso-item__logo">
                        <img src="../assets/cursos/orcamento-mensal-logo.svg" />
                      </div>
                    </header>
                ...
                <li>
                  <Box className="curso-item">
                    <header className="flex curso-item__header align-items">
                      <div className="curso-item__logo">
                        <img src="../assets/cursos/dinheiro-dia-a-dia-logo.svg" />
                      </div>
                    </header>
