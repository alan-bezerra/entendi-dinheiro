    ...
    <div className="app-container">
      ...
      <section className="competencias">
        ...
        <div className="competencia-item">
          <img src="/icones/carteira-icone.png" className="competencia-icone" alt="" />
      ...
      <section className="links">
        ...
        <div className="redes-sociais-icones">
          <div className="icone-rede-social">
            <img src="/icones/linkedin-icone.png" alt="LinkedIn" />
          </div>
          <div className="icone-rede-social">
            <img src="/icones/facebook-icone.png" alt="Facebook" />
          </div>
          <div className="icone-rede-social">
            <img src="/icones/instagram-icone.png" alt="Instagram" />
          </div>
        </div>
      </section>
